---
name: skala-review
description: SKALA 교육생의 복습·학습 정리 스킬. /skala-review 호출 후 강의 PDF·메모·키워드로 질문식 복습, 빠른 요약, 간결한 플랫폼용 초안, Velog·Notion·Tistory용 복습 글 작성 가이드, 동의한 Markdown 노트 저장 또는 이전 노트 재복습을 진행한다.
